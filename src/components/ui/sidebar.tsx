...
import { useIsLaptop } from "@/lib/hooks/use-laptop"
  ...
  (
    ...
    const toggleSidebar = React.useCallback(() => {
      return isLaptop
        ...
        : setOpen((open) => !open)
    }, [isLaptop, setOpen, setOpenMobile])
    ...
    const contextValue = React.useMemo<SidebarContext>(
      ...
      [state, open, setOpen, isLaptop, openMobile, setOpenMobile, toggleSidebar]
    )
...
>(
  (
    ...
    const { isLaptop, state, openMobile, setOpenMobile } = useSidebar()
...
>(
  (
    ...
    const Comp = asChild ? Slot : "button"
    const { isLaptop, state } = useSidebar()
    ...
    return (
      <Tooltip>
        ...
        <TooltipContent
          side="right"
          align="center"
          hidden={state !== "collapsed" || isLaptop}
          {...tooltip}
        />
      </Tooltip>
    )
